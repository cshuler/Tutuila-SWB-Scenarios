...
# Dynamic_input file for swb2, Samoa Test Case 
...
FRAGMENTS_DAILY_FILE ../Dynamic_input/Rainfall_fragments_2001.prn
FRAGMENTS_SEQUENCE_FILE ../Dynamic_input/Sequence_file_2002.prn
...
TMAX ARC_GRID ../Dynamic_input/Gridded_temps/prism_tmax_tutuila_30yr_normal_%0m.asc
...
TMIN ARC_GRID ../Dynamic_input/Gridded_temps/prism_tmin_tutuila_30yr_normal_%0m.asc
...
(6) "standard" GIS Dynamic_input grids: hydrologic soils group, available water capacity, soils, and flow direction 
----------------------------------------------------------------------------------------------------------- 
...
LAND_USE ARC_GRID ../Dynamic_input/Land_use_Soils_data/lu_grid.asc
...
#RUNOFF_ZONE ARC_GRID ../Dynamic_input/Runoff_zones_WS/ro_rast.asc
#RUNOFF_ZONE_PROJECTION_DEFINITION +proj=utm +zone=2 +south +ellps=WGS84 +datum=WGS84 +units=m +no_defs 
 
#RUNOFF_RATIO_MONTHLY_FILE ../Dynamic_input/RO_Rf_ratios_real_monthly3_2000_2010.txt
